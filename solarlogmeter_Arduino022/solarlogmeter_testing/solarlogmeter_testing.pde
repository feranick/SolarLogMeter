...
String versProg = "0.10.2 - 20111019";
...
//int potSteps[] = {60, 60, 60, 60, 60, 60, 60, 60, 256};  //steps for the potentiometer for each fixed resistor connected in parallel
int potSteps[] = { 100, 100, 50, 50, 256};  //steps for the potentiometer for each fixed resistor connected in parallel

int numFixedRes = 4;
const int Tr[]= {
  38, 39, 40, 41, 42, 43, 44, 45};  //ransistor ports for fixed resistors
