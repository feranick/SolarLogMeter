...
String versProg = "0.9.10 (I2C pots) - 20111006";
...
void ivSingle() {
  ...
  { 
    ...
    for (int g=0; g<4; g++) {
      digitalPotWriteI2C(44, (byte) g, 255-j);
      digitalPotWriteI2C(45, (byte) g, 255-j);
    }
 //delay(2000);
      
      //For second I2C potentiometer
      //digitalPotWriteI2C(45, 0x00, 255-j);
      //digitalPotWriteI2C(45, 0x01, 255-j);
